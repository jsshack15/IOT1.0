...
var GwdDoubleClickConstants = {EVENT_DETAIL_URL:"url", EXPANDED_PAGE:"data-gwd-expanded", FULLSCREEN_CLASS_NAME:"fs", GWD_DATABINDER:"gwd-data-binder", GWD_YOUTUBE:"gwd-youtube", HANDLED:"handled", HTML_AUDIO:"audio", HTML_VIDEO:"video", START_PAGE_TRANSITION_DELAY:30, TAG_NAME:"gwd-doubleclick", Attributes:{DATA_PROVIDER:"data-provider", FULLSCREEN:"fullscreen", POLITE_LOAD:"polite-load"}, Events:{AD_INITIALIZED:"adinitialized", COLLAPSE_FINISH:"collapsefinish", COLLAPSE_START:"collapsestart", EXPAND_FINISH:"expandfinish", 
EXPAND_START:"expandstart", FULLSCREEN_SUPPORT:"fullscreensupport"}};
...
GWDDynamicDataSelectorImpl.prototype.handleDomContentLoaded_ = function() {
  if (this.isUsingStudioStandardSchema_()) {
    ...
    if (datasetId && hasCustomFeeds_()) {
      ...
      dataset && Enabler.setAdParameters("layoutsConfig=" + JSON.stringify(dataset.feed));
    }
  }
};
